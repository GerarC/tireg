...
func TestNewCheckHealthUseCase_CheckHealth_ReturnsUpStatus(t *testing.T) {
	checkHealthUseCase := usecase.NewCheckHealthUseCase()

	healthStatus := checkHealthUseCase.CheckHealth()
